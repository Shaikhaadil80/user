                ...
                InkWell(
                  onTap: () async {
                    ...
                    _con.addAddress(new Address.fromJSON({
                      'address': pickedResult!.formattedAddress,
                      'latitude': pickedResult!.geometry!.location.lat,
                      'longitude': pickedResult!.geometry!.location.lng,
                    }));
                    print("result = $pickedResult");
