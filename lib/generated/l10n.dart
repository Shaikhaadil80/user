...
class S {
  ...
  String get select_your_country_code {
    return Intl.message(
      'Select your country code',
      name: 'select_your_country_code',
      desc: '',
      args: [],
    );
  }
  ...
  String get account_email_has_not_been_verified {
    return Intl.message(
      'Account email has not been verified',
      name: 'account_email_has_not_been_verified',
      desc: '',
      args: [],
    );
  }
  ...
  String get set_your_delivery_date {
    return Intl.message(
      'Set your delivery date',
      name: 'set_your_delivery_date',
      desc: '',
      args: [],
    );
  }
  ...
  String get email_verification_link_has_been_sent_to {
    return Intl.message(
      'Email verification link has been sent to',
      name: 'email_verification_link_has_been_sent_to',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Should be a valid id number`
  String get should_be_a_valid_id_number {
    return Intl.message(
      'Should be a valid id number',
      name: 'should_be_a_valid_id_number',
      desc: '',
      args: [],
    );
  }
  ...
  String get select_customer_type {
    return Intl.message(
      'Select Customer Type',
      name: 'select_customer_type',
      desc: '',
      args: [],
    );
  }
  ...
  String get should_be_valid_mobile_number {
    return Intl.message(
      'Should be valid mobile number',
      name: 'should_be_valid_mobile_number',
      desc: '',
      args: [],
    );
  }
  ...
  String get identification_number {
    return Intl.message(
      'Identification number',
  ...
  String get no_markets_available {
    return Intl.message(
      'No markets available',
      name: 'no_markets_available',
      desc: '',
      args: [],
    );
  }
  ...
  String get trending_products_will_appear_here {
    return Intl.message(
      'Trending products will appear here',
      name: 'trending_products_will_appear_here',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_gifts_will_appear_here {
    return Intl.message(
      'Your gifts will appear here',
      name: 'your_gifts_will_appear_here',
      desc: '',
      args: [],
    );
  }
  ...
  String get failed_loading_items {
    return Intl.message(
      'Failed loading items',
      name: 'failed_loading_items',
      desc: '',
      args: [],
    );
  }

  /// `Pick from my location`
  String get pick_from_my_location {
    return Intl.message(
      'Pick from my location',
      name: 'pick_from_my_location',
      desc: '',
      args: [],
    );
  }
  ...
  String get no_suggestions_found {
    return Intl.message(
      'No suggestions found',
      name: 'no_suggestions_found',
      desc: '',
      args: [],
    );
  }

  /// `Failed loading suggestions`
  String get failed_loading_suggestions {
    return Intl.message(
      'Failed loading suggestions',
      name: 'failed_loading_suggestions',
      desc: '',
      args: [],
    );
  }
  ...
  String get suggestions_will_appear_here {
    return Intl.message(
      'Suggestions will appear here',
      name: 'suggestions_will_appear_here',
      desc: '',
      args: [],
    );
  }
