...
import 'src/pages/verification_email.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/emailVerification':
        return MaterialPageRoute(
            builder: (_) =>
                EmailVerificationWidget(routeArgument: args as RouteArgument));
      case '/Product':
        return MaterialPageRoute(
            builder: (_) =>
      ...
      case '/Brand':
        return MaterialPageRoute(
            builder: (_) => BrandPage(routeArgument: args as RouteArgument));
      case '/Cart':
        return MaterialPageRoute(
      ...
      case '/gifts':
        return MaterialPageRoute(builder: (_) => GiftsWidget());
